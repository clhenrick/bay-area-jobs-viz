// URL: https://beta.observablehq.com/d/9522605bad3208b9
// Title: SF Bay Area Jobs Viz SVG Exporter v2
// Author: Chris Henrick (@clhenrick)
// Version: 565
// Runtime version: 1

const m0 = {
  id: "9522605bad3208b9@565",
  variables: [
    {
      inputs: ["md"],
      value: (function(md){return(
md`# SF Bay Area Jobs Viz SVG Exporter v2

Forked from original to use diverging color schemes for both the 2015 LQ and change in LQ from 2015 – 2002.
...
slider({
  ...
  description: "Selects the quintile group (0 – 4), and all others above it. Quintiles taken of job density (total job count / geographic area)"
    ...
    {
      name: "choropleth",
      inputs: ["DOM","map","d3","tracts","path","toggleValue","greys","lqChangeScale","lq2015Scale","jobDensityQuintile","topojson","tractsTopoJSON","topojsonObj","boundaryFilter","tractsOutline","showMapframe"],
      value: (function(DOM,map,d3,tracts,path,toggleValue,greys,lqChangeScale,lq2015Scale,jobDensityQuintile,topojson,tractsTopoJSON,topojsonObj,boundaryFilter,tractsOutline,showMapframe)
{
  ...
  tractsUpdate
    ...
    .attr("fill", d => {
      ...
      return toggleValue ? lqChangeScale(value) : lq2015Scale(value)
    })
...
md`### legend`
    ...
    {
      name: "legend",
      inputs: ["legendSpec","d3","DOM","xScale","toggleValue","lqChangeScale","lq2015Scale","xAxis"],
      value: (function(legendSpec,d3,DOM,xScale,toggleValue,lqChangeScale,lq2015Scale,xAxis)
{
  ...
  g.append("g")
    ...
    .attr("fill", d => toggleValue ? lqChangeScale(d[0]) : lq2015Scale(d[0]))
...
md`### legend helpers`
    ...
    {
      name: "legendSpec",
      inputs: ["toggleValue","selectedCategoryLabel","lqChangeExtent","lqChangeThresholds","lq2015Extent","lq2015Thresholds"],
      value: (function(toggleValue,selectedCategoryLabel,lqChangeExtent,lqChangeThresholds,lq2015Extent,lq2015Thresholds){return(
{
  ...
  domain: toggleValue 
    ? [lqChangeExtent[0], ...lqChangeThresholds, lqChangeExtent[1]]
    : [lq2015Extent[0], ...lq2015Thresholds, lq2015Extent[1]]
}
)})
    },
    {
...
md`I chose to limit the palette to ${numberClasses} classes so that the color ramps are optimized for print. For the 2015 LQ I've limited it to 4, as the very bottom class of the diverging scale is not needed.`
)})
    },
    {
      name: "numberClasses",
...
[-1.5, -0.1, 0.1, 1.5]
    ...
    {
      name: "lqChangeScale",
      inputs: ["d3","lqChangeThresholds","curRamp"],
      value: (function(d3,lqChangeThresholds,curRamp){return(
d3.scaleThreshold()
...
[0.8, 1.2, 1.5]
    ...
    {
      name: "lq2015Scale",
      inputs: ["d3","lq2015Thresholds","curRamp"],
      value: (function(d3,lq2015Thresholds,curRamp){return(
d3.scaleThreshold()
  .domain(lq2015Thresholds)
  .range(curRamp.slice(1))
)})
    },
    {
      inputs: ["md"],
